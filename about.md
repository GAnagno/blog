...
Mathematically, a node exists only if connected and objects are defined by their roles in the network. An exciting approach on the topic is Representation Learning on Graphs as exemplified by modern researchers who merge Graph Theory, Signal Processing and Deep Learning.
